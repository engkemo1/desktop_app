...
class CustomerScreen extends StatelessWidget {
          ...
          return state is GetCustomersLoadingState
              ...
              : data.customerModelList.isEmpty
                  ...
                  : Directionality(
                      ...
                      child: buildCardDesktop(data, context,isSmallScreen));
        }),
      ),
    );
  }

  buildCardDesktop(CustomersCubit data, BuildContext context,var isSmallScreen) {
    ...
    return Container(
      ...
      child: DataTable(
        ...
        rows: List.generate(
          ...
          (index) {
            return buildDataRow(index, data, context,isSmallScreen);
          },
        ),
        columns: const [
          DataColumn(
  ...
  DataRow buildDataRow(int index, CustomersCubit data, BuildContext context,var isSmallScreen) {

    return DataRow(cells: [
      DataCell(
          Center(child: Text(data.customerModelList[index].userName ?? ''))),
      ...
      DataCell(Center(
          child:
              Text(data.customerModelList[index].remainingAmount.toString()))),
      DataCell(Row(
